...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> atualizar(@PathVariable Long codigo, @Valid @RequestBody Lancamento lancamento) {
		Lancamento lancamentoAtualizado = lancamentoService.atualizar(codigo, lancamento); // Repassado a classe de serviço(regra de negocio) para que atualize o objeto lancamento

		return ResponseEntity.ok(lancamentoAtualizado); // mensagem positiva ao usuário
	}
